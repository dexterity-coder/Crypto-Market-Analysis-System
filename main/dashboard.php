                            ...
                            <div class="col-xl-8 col-12">
                                ...
                                <div class="box">
                                    <div class="box-header with-border">
                                        <h4 class="box-title">LIVE CRYPTO NEWS FEED</h4>
                                    ...
                                    <div class="box-body">
                                        <div class="chart mb-20">
                                            <div id="chartdiv1" class="h-500">

                                                <!-- start sw-rss-feed code --> 
                                                <script type="text/javascript">
                                                    <!-- 
                                                    rssfeed_url = new Array();
                                                    rssfeed_url[0] = "https://cointelegraph.com/rss/tag/bitcoin";
                                                    ...
                                                    rssfeed_no_items = "0";
                                                    rssfeed_cache = "6aa835256c21c7ee896aab438a97cce5";
                                                    //--> 
                                                </script> 
